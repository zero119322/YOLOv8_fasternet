...
from .fasternet import MLPBlock
...
class C2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, mlp_ratio=4, drop_path=0.1, e=0.5):
        ...
        self.m = nn.ModuleList(MLPBlock(self.c,n_div=4,mlp_ratio=mlp_ratio,drop_path=drop_path) for _ in range(n))
